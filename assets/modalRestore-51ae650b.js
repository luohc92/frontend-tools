import{d as ee,r as k,b as ne,E as te,e as se,c as le,a as I,f as l,w as r,u as x,o as oe,t as D,g as B,i as C,h as q,n as ae,_ as ie}from"./index-d9ed2ae6.js";import{c as re,d as ue,b as ce,E as fe,a as pe,e as de,f as me,g as ge,M as J}from"./mirrorEditor-9498d342.js";import{j as he}from"./index-841daa79.js";import"./index-c7730d8c.js";const _e={class:"tool-head"},be={class:"value"},ve={class:"value"},ye={class:"right"},we=ee({__name:"modalRestore",setup(xe){const{toClipboard:F}=re(),v=k(`{
...
`),j&&i){if(a&&a.length>=2){const o=w.find(c=>c.key===i);if(a&&a.length>=3){const c=w.find(L=>L.key===o.key);if(c&&c.parentKey){const L=w.filter(U=>U.parentKey===c.parentKey);if(L.length-1===c.index)e=`${e}},
...
`}}return O(n,s,p,f,_,$),e=he.js_beautify(e+y),e},Y=n=>{const s=[];function p(f,_,$,y){f&&typeof f=="object"&&!Array.isArray(f)?(_&&s.push({key:_,parentKey:$,index:y}),$=_,Object.keys(f).forEach((w,e)=>{p(f[w],w,$,e)})):s.push({key:_,parentKey:$,index:y})}return p(n,"","",0),s},Z=()=>{if(v.value)try{const n=JSON.parse(v.value);v.value="",ae(()=>{v.value=JSON.stringify(n,null,4)})}catch(n){return q.info("JSON格式不正确：",n==null?void 0:n.message)}},K=async()=>{if(!E.value)return q.info("没有内容");try{await F(E.value),V.value=!0,setTimeout(()=>{V.value=!1},1e3)}catch{V.value=!1,q.error("复制失败")}};return(n,s)=>{const p=ue,f=ce,_=fe,$=pe,y=te,w=de,e=se,O=me,N=ge;return oe(),le("div",null,[I("div",_e,[l(w,{"label-width":"40px",inline:!0,size:"small",class:"no-bottom"},{default:r(()=>[l(f,{label:"assign定义","label-width":"80px"},{default:r(()=>[l(p,{modelValue:x(u).modalAssign,"onUpdate:modelValue":s[0]||(s[0]=t=>x(u).modalAssign=t),size:"small","fetch-suggestions":Q,onSelect:P,clearable:"",class:"w-100",placeholder:"输入或选择"},{default:r(({item:t})=>[I("div",be,D(t),1)]),_:1},8,["modelValue"])]),_:1}),l(f,{label:"默认number","label-width":"90px"},{default:r(()=>[l(p,{modelValue:x(u).typeSuffix,"onUpdate:modelValue":s[1]||(s[1]=t=>x(u).typeSuffix=t),size:"small","fetch-suggestions":H,onSelect:G,clearable:"",class:"w-100",placeholder:"输入或选择"},{default:r(({item:t})=>[I("div",ve,D(t),1)]),_:1},8,["modelValue"])]),_:1}),l(f,{label:"首字母","label-width":"50px"},{default:r(()=>[l($,{modelValue:x(u).firstLetter,"onUpdate:modelValue":s[2]||(s[2]=t=>x(u).firstLetter=t),class:"w-100"},{default:r(()=>[l(_,{label:"默认",value:"default"}),l(_,{label:"大写",value:"uppercase"}),l(_,{label:"小写",value:"lowercase"})]),_:1},8,["modelValue"])]),_:1}),l(f,null,{default:r(()=>[l(y,{type:"default",onClick:Z},{default:r(()=>[B("格式化")]),_:1}),l(y,{type:"primary",onClick:W},{default:r(()=>[B("转换")]),_:1})]),_:1})]),_:1}),I("div",ye,[l(e,{visible:x(V),"show-arrow":!1,effect:"light",placement:"left",content:"复制成功"},{default:r(()=>[l(y,{type:"default",size:"small",onClick:K},{default:r(()=>[B("复制")]),_:1})]),_:1},8,["visible"])])]),l(N,null,{default:r(()=>[l(O,{span:12},{default:r(()=>[l(J,{class:"r-b",value:x(v),"onUpdate:value":s[3]||(s[3]=t=>C(v)?v.value=t:null),height:R,language:"json",placeholder:"请输入JSON"},null,8,["value"])]),_:1}),l(O,{span:12},{default:r(()=>[l(J,{value:x(E),"onUpdate:value":s[4]||(s[4]=t=>C(E)?E.value=t:null),language:"typescript",height:R},null,8,["value"])]),_:1})]),_:1})])}}}),Le=ie(we,[["__file","C:/Users/luohc/Documents/work/frontend-tools-box/src/views/modalRestore/modalRestore.vue"]]);export{Le as default};
